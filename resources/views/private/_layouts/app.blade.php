...
<body>
    <div class="container-scroller">
        <!-- partial:paccueilartials/_navbar.html -->

        @if (!request()->routeIs('public.inscription-option') && !request()->routeIs('public.inscription-promoteur') &&
        !request()->routeIs('public.inscription-abonne') && !request()->routeIs('public.connexion'))
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-brand-wrapper d-flex justify-content-center">
                <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                    <a class="navbar-brand brand-logo" href="index.html"><img
                            src="{{ asset('assets_private/images/logo.svg') }}" alt="logo" /></a>
                    <a class="navbar-brand brand-logo-mini" href="index.html"><img
                            src="{{ asset('assets_private/images/logo-mini.svg') }}" alt="logo" /></a>
