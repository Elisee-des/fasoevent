    ...
    <div class="row flex-grow">
        <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
                ...
                <form action="{{ route('public.inscription-abonne-action') }}" method="POST" class="pt-3">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <textarea name="preferences" class="form-control form-control-lg border-left-0"
                                placeholder="Entrez vos préférences" id="" cols="10" rows="5"></textarea>
                    ...
                    <div class="text-center mt-4 font-weight-light">
                        Avez-vous déja un compte ? <a href="{{ route('public.connexion') }}" class="text-primary">Se
                            connecter</a>
                    </div>
                </form>
            </div>
