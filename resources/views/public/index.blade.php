        ...
        <div class="container">
            ...
            <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                    <img src="{{ asset('assets_public/img/portfolio/OIP (4).jpg') }}" class="img-fluid" alt="" />
                    <div class="portfolio-info">
                        <h4>évènement 4</h4>

                        <a href="{{ asset('assets_public/img/portfolio/OIP (4).jpg') }}" data-gallery="portfolioGallery"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                    <img src="{{ asset('assets_public/img/portfolio/OIP (5).jpg') }}" class="img-fluid" alt="" />
                    <div class="portfolio-info">
                        <h4>évènement 5</h4>

                        <a href="{{ asset('assets_public/img/portfolio/OIP (5).jpg') }}" data-gallery="portfolioGallery"
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                    <div class="member">
                        ...
                        <div class="member-info">
                            ...
                            <span>Responsable de la Communication: Herman BAKOUAN excelle
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                    <div class="member">
                        ...
                        <div class="member-info">
                            <h4>Arlette ZONGO</h4>
                            <span>Consultante Culturelle: Fort de son expertise, Pierre offre
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                    <div class="member">
                        ...
                        <div class="member-info">
                            ...
                            <span>Spécialiste en Promotion: Elisée SABIDANI, en tant que
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                    <div class="member">
                        ...
                        <div class="member-info">
                            <h4>Fassia OUANRE</h4>
                            <span>Gestionnaire d'Événements: Avec une expertise éprouvée dans
                ...
                <ul>
                    <li data-aos="fade-up">
                        ...
                        <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">
                            ...
                            à la plateforme ? <i class="bx bx-chevron-down icon-show"></i><i
                    ...
                    <li data-aos="fade-up" data-aos-delay="200">
                        <i class="bx bx-help-circle icon-help"></i>
                        <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">Comment fonctionne
                            la billetterie en ligne sur votre
                            plateforme ? <i class="bx bx-chevron-down icon-show"></i><i
                                class="bx bx-chevron-up icon-close"></i></a>
                    ...
                    <li data-aos="fade-up" data-aos-delay="300">
                        <i class="bx bx-help-circle icon-help"></i>
                        <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">Les billets en ligne
                    ...
                    <li data-aos="fade-up" data-aos-delay="400">
                        <i class="bx bx-help-circle icon-help"></i>
                        <a data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">Comment puis-je
                            promouvoir mon événement à travers votre
                            plateforme ? <i class="bx bx-chevron-down icon-show"></i><i
                                class="bx bx-chevron-up icon-close"></i></a>
                    ...
                    <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                        ...
                        <div class="my-3">
                            ...
                            <div class="sent-message">
                                contenu Votre message a été envoyé. merci!
                            </div>
                        </div>
                        <div class="text-center">
